    ...
    <div className="country-detail">
      <div className="container text-start py-5 ">
        <button
          ...
          className="px-4 py-2 border-0 mb-5 d-flex gap-2 align-items-center rounded-2 bg-element custom-text-white shadow-lg"
        >
          <FaArrowLeftLong />
          Back
        </button>
        <div className="d-flex flex-column gap-5 flex-md-row text-start">
          <img
          ...
          <div className="d-flex flex-column gap-4">
            ...
            <div className="border-div">
              <p>
                <span className="fw-semibold">Borders:</span>{" "}
              </p>
            </div>
          </div>
        </div>
